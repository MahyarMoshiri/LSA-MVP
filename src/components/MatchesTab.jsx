...
import { Search, X, Users, Building, Calendar, ArrowRight, GitBranch } from 'lucide-react'

const MatchesTab = ({ data, onRemoveMatch, onGoToProgression, onQuickUpdate, isUpdating }) => {
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => onGoToProgression && onGoToProgression(match.match_id)}
